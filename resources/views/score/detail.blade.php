                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Penilaian / {{ $data['class']->nama }}
                                    ({{ $data['class']->tahun_ajaran }} - {{ $data['class']->smester }})</h3>
    ...
    @push('custom')
        ...
        <script>
            $(document).ready(function() {
                ...
                var route;
                route = '{{ route('score.matkulPerKelas.dataGet', ['id' => $data['class']->id]) }}?smester=' + smester
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                var route = '{{ route('score.AbsentAdmin', ['id' => ':id']) }}'
                                route = route.replace(':id', data.id);
                                return '<a href="' + route + '" class="btn btn-sm btn-warning">Penilaian</a> ';
                            },
                            name: 'action'
                        }
                    ],
                ...
                $('.smester').change(function() {
                    ...
                    console.log(smester);
                    route =
                        '{{ route('score.matkulPerKelas.dataGet', ['id' => $data['class']->id]) }}?smester=' +
                        smester
