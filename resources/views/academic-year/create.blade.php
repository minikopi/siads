                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Form Pembuatan Data Tahun Ajaran
                                </h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <form method="POST" action="{{ route('academic-year.store') }}"
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="visible" type="checkbox" value="1"
                                                            id="visible" @checked(old('visible') == 1)>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="active" type="checkbox" value="1"
                                                            id="active" @checked(old('active') == 1)>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="registration" type="checkbox" value="1"
                                                            id="registration" @checked(old('registration') == 1)>
