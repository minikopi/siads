    ...
    @push('custom')
        ...
        <script>
            $(document).ready(function() {
                ...
                var route;
                route = '{{ route('mahasantri.nilai.data') }}?smester=' + smester
                ...
                $('#cetakKHS').on('click', function() {
                    semester = $('.smester').val();
                    window.location.href = '{{ route('mahasantri.nilai.print', ['id' => Auth::user()->mahasantri->kelas_id]) }}&semester=' + semester;
                });
                // {{ route('mahasantri.nilai.print', ['id' => Auth::user()->mahasantri->kelas_id]) }}
            });
        </script>
    @endpush
@endsection
