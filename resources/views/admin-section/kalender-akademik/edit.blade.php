                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Form Ubah Data Kalender Akademik</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <form method="POST" action="{{ route('administrator.akademik.update', $akademik) }}"
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control @error('tanggal_mulai') is-invalid @enderror"
                                                        ...
                                                        value="{{ old('tanggal_mulai', $akademik->tanggal_mulai->format('Y-m-d')) }}">
                                                    @error('tanggal_mulai')
                                                        <div class="invalid-feedback" style="color: red;">{{ $message }}
                                                        </div>
                                                    @enderror
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control @error('tanggal_akhir') is-invalid @enderror"
                                                        ...
                                                        value="{{ old('tanggal_akhir', $akademik->tanggal_akhir->format('Y-m-d')) }}">
                                                    @error('tanggal_akhir')
                                                        <div class="invalid-feedback" style="color: red;">{{ $message }}
                                                        </div>
                                                    @enderror
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-select @error('semester') is-invalid @enderror"
                                                        ...
                                                        <option value="Ganjil"
                                                            @selected(old('semester', $akademik->semester) == 'Ganjil')>Ganjil
                                                        </option>
                                                        <option value="Genap"
                                                            @selected(old('semester', $akademik->semester) == 'Genap')>Genap</option>
                                                    </select>
                                                    @error('semester')
                                                        <div class="invalid-feedback" style="color: red;">{{ $message }}
                                                        </div>
                                                    ...
                                                    <select class="form-select @error('tahun_ajaran') is-invalid @enderror"
                                                        ...
                                                        @foreach ($academic_years as $academic_year)
                                                            <option
                                                                ...
                                                                @selected(old('tahun_ajaran', $akademik->tahun_ajaran) == $academic_year->full_year)
                                                            >
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control @error('keterangan') is-invalid @enderror"
                                                        ...
                                                        value="{{ old('keterangan', $akademik->keterangan) }}">
                                                    @error('keterangan')
                                                        <div class="invalid-feedback" style="color: red;">{{ $message }}
                                                        </div>
                                                    @enderror
