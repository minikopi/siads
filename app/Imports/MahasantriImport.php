...
class MahasantriImport implements ToCollection, WithHeadingRow
// class MahasantriImport implements ToCollection, WithHeadingRow, WithValidation, SkipsOnFailure, SkipsEmptyRows,  WithSkipDuplicates, WithColumnFormatting
{
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $key => $row) {
            ...
            // if (empty($row['nama_depan']) && empty($row['nama_belakang']) && empty($row['email'])) {
            //     Log::info('Skip baris kosong saat import mahasantri', [
            //         'action' => 'import mahasantri',
            //         'row' => $key + $this->headingRow(),
            ...
            try {
                ...
                //     'handphone' => trim((int) $row['nomor_handphone']),
                //     'whatsapp' => trim((int) $row['nomor_handphone']),
                //     'nik' => trim((int) $row['nik']),
                //     'alamat' => trim($row['alamat']),
                //     'kode_pos' => trim((int) $row['kode_pos']),
                ...
                //     'suku' => trim($row['suku']),
                //     'saudara' => trim((int) $row['saudara']),
                //     'anak_ke' => trim((int) $row['anak_ke']),
                ...
                //     'penghasilan_ayah' => trim((int) $row['penghasilan_ayah']),
                ...
                //     'penghasilan_ibu' => trim((int) $row['penghasilan_ibu']),
                //     'nama_wali' => trim($row['nama_wali']),
                //     'alamat_wali' => trim($row['alamat_wali']),
                //     'handphone_wali' => trim((int) $row['handphone_wali']),
                //     'whatsapp_wali' => trim((int) $row['handphone_wali']),
                ...
                //     'berat_badan' => trim((int) $row['berat_badan']),
                //     'tinggi_badan' => trim((int) $row['tinggi_badan']),
